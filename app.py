...
lineaccesstoken = 'khAAGhvXpx1n4/pdKipMgEKjEGz+Jlez9+5Veh35A2/NTeM9Csc7fcOs9I59lsifvFxAi/QIbdUFFB/PJDfev5rUR5XgAg/lTjEjDRUz+6PGoWoWPjwNwlZsZ68a5Klgv8ULb3z0KZAWxwn6EN8GbgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            replyObj = TextSendMessage(text="ดีจ้าพส.")
        elif (msg == "กินข้าวรึยัง??" :
            replyObj = TextSendMessage(text="ยังเลยแม่TT")
        elif (msg == "ไปเที่ยวกันไหมคะ" :
            replyObj = TextSendMessage(text="ไปไม่ได้อ่าา")  
        else :    
